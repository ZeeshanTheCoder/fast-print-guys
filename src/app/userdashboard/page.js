              ...
              <div className="px-4 md:px-6 py-4 md:py-5 bg-gray-50">
                <div className="grid grid-cols-3 gap-3 md:gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-xs md:text-sm font-medium text-gray-700">Create</p>
                  </div>
                  <div className="text-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-[#016AB3]/10 rounded-full flex items-center justify-center mx-auto mb-1 md:mb-2">
                      <FaChartLine className="text-[#016AB3] text-sm md:text-base" />
                    </div>
                    <p className="text-xs md:text-sm font-medium text-gray-700">Track</p>
                  </div>
                  <div className="text-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-[#016AB3]/10 rounded-full flex items-center justify-center mx-auto mb-1 md:mb-2">
                      <FaCheckCircle className="text-[#016AB3] text-sm md:text-base" />
                    </div>
                    <p className="text-xs md:text-sm font-medium text-gray-700">Complete</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl md:text-4xl font-bold text-[#016AB3] mt-1 md:mt-2">{books.length}</p>
            ...
            <div className="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl md:text-4xl font-bold text-emerald-600 mt-1 md:mt-2">{getUserCart().length}</p>
          ...
          <div className="bg-white shadow-xl md:shadow-2xl rounded-2xl md:rounded-3xl overflow-hidden border border-gray-100">
            ...
            <div className="bg-gradient-to-r from-[#016AB3] via-[#0096CD] to-[#00AEDC] px-4 md:px-8 py-6 md:py-8 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <h1 className="text-white text-xl md:text-2xl font-bold mb-1 md:mb-2">Project Management</h1>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {filteredBooks.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="3" className="px-6 md:px-8 py-12 md:py-16 text-center">
                        <div className="flex flex-col items-center justify-center text-gray-500">
                          ...
                          <p className="text-base md:text-lg font-semibold text-gray-700">No projects found</p>
              ...
              {filteredBooks.length > 0 ? (
                <div className="divide-y divide-gray-200">
                  {filteredBooks.map((book) => (
                    <div key={book.id} className="p-4 hover:bg-gradient-to-r hover:from-[#F8FAFF] hover:to-[#F0F7FF] transition-all duration-300">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              Created {book.created_at ? new Date(book.created_at).toLocaleDateString() : new Date().toLocaleDateString()}
                            </div>
                          </div>
                        </div>
                      </div>
